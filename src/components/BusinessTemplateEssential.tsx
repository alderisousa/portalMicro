...
export function BusinessTemplateEssential({ business }: { business: Business }) {
  ...
  return <article className="business-template template-essential">
    ...
    <div className="essential-content">
      {business.story && <section className="template-story essential-story" aria-labelledby="essential-story-title"><span className="template-section-kicker">Apresentação</span><h2 id="essential-story-title">Saiba mais</h2><StoryContent story={business.story} /></section>}
