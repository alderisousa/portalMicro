...
export function BusinessTemplateFeatured({ business }: { business: Business }) {
  ...
  return <article className={`business-template template-featured${heroPhoto ? '' : ' without-hero-photo'}`}>
    ...
    <div className="featured-content">
      {business.story && <section className="template-story featured-story" aria-labelledby="featured-story-title"><p className="eyebrow">Sobre o negócio</p><h2 id="featured-story-title">Nossa história</h2><StoryContent story={business.story} /></section>}
